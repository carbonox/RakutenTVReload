...
public class FragmentoListaPeliculasMisFavoritos extends Fragment{
    ...
    private static FragmentoListaPeliculasMisFavoritos fragmentoListaPeliculasMisFavoritos;

    public static FragmentoListaPeliculasMisFavoritos getInstance() {
        return fragmentoListaPeliculasMisFavoritos;
    }
        ...
        protected void onPostExecute(Boolean resp) {
            try {
                if (resp && listaPeliculas != null && listaPeliculas.size() > 0) {
                    ...
                    Toast.makeText(getActivity(), "Todavía no tienes Favoritos", Toast.LENGTH_SHORT).show();
                }
            } catch (Exception e) {
