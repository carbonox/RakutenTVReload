...
public class FragmentoListaPeliculasRanking extends Fragment{


    private static FragmentoListaPeliculasRanking fragmentoListaPeliculasRanking;

    public static FragmentoListaPeliculasRanking getInstance() {
        return fragmentoListaPeliculasRanking;
    }
    ...
    public FragmentoListaPeliculasRanking() {
        // Required empty public constructor
    }


    public static FragmentoListaPeliculasRanking newInstance(String param1, String param2) {
        FragmentoListaPeliculasRanking fragment = new FragmentoListaPeliculasRanking();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        parametros.put("ACTION", "PELICULA.RANKING");
