...
public class FragmentoInfoPeliculaCines extends Fragment {


    private static FragmentoInfoPeliculaCines fragmentoInfoPelicula;

    public static FragmentoInfoPeliculaCines getInstance() {
    ...
    public FragmentoInfoPeliculaCines() {
        // Required empty public constructor
    }


    public static FragmentoInfoPeliculaCines newInstance() {
        FragmentoInfoPeliculaCines fragment = new FragmentoInfoPeliculaCines();
...
//        switchFav = (Switch) vista.findViewById(R.id.infoFav);
        ...
        new FragmentoInfoPeliculaCines.BitmapWorkerTask(imageViewFoto).execute(pelicula.getFoto());
