...
public class FragmentoListaPeliculasMisCompras extends Fragment{


    private static FragmentoListaPeliculasMisCompras fragmentoListaPeliculasMisCompras;

    public static FragmentoListaPeliculasMisCompras getInstance() {
        return fragmentoListaPeliculasMisCompras;
    }
    ...
    public FragmentoListaPeliculasMisCompras() {
        // Required empty public constructor
    }


    public static FragmentoListaPeliculasMisCompras newInstance(String param1, String param2) {
        FragmentoListaPeliculasMisCompras fragment = new FragmentoListaPeliculasMisCompras();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        parametros.put("ACTION", "PELICULA.MISCOMPRAS");
